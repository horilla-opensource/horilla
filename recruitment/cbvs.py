...
class LinkedinSettingSectionView(views.HydraSectionView):
    """
...
class LinkedInSettingNavView(views.HydraNavView):
    """
...
class LinkedInAccountFormView(views.HydraFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.HydraListView):
    """
