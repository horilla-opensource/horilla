...
def employee_pivot(request):
    ...
    data = EmployeeWorkInformation.objects.values(
        'employee_id__employee_first_name','employee_id__employee_last_name', 'employee_id__gender','employee_id__email','employee_id__phone','department_id__department','job_position_id__job_position',
        'job_role_id__job_role','work_type_id__work_type','shift_id__employee_shift','employee_type_id__employee_type','reporting_manager_id__employee_first_name',
        'reporting_manager_id__employee_last_name','company_id__company','date_joining','experience'
    )
    choice_gender = {
        "male": "Male",
        "female": "Female",
