...
from hydra.hydra_apps import INSTALLED_APPS

"""
DB_INIT_PASSWORD: str

The password used for database setup and initialization. It has no built-in
default and must be supplied through the environment when this feature is used.
"""
