...
MIDDLEWARE.append("hydra.hydra_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("hydra.hydra_middlewares.ThreadLocalMiddleware")
MIDDLEWARE.append("hydra.hydra_middlewares.SVGSecurityMiddleware")
