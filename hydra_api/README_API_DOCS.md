...
This document provides information on how to use and maintain the API documentation for Hydra HRMS.
...
```python
from hydra_api.docs import document_api
...
- Module tags are defined in `hydra_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `hydra_api/urls.py`
