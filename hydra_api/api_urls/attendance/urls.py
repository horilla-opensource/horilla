"""
hydra_api/urls/attendance/urls.py
"""

from django.urls import path

from hydra_api.api_views.attendance.permission_views import AttendancePermissionCheck
from hydra_api.api_views.attendance.views import *
