...
from hydra_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class HydraListView(ListView):
    ...
    template_name: str = "generic/hydra_list_table.html"
...
class HydraSectionView(TemplateView):
    ...
    template_name = "generic/hydra_section.html"
...
class HydraTabView(TemplateView):
    ...
    template_name = "generic/hydra_tabs.html"
...
class HydraCardView(ListView):
    ...
    template_name = "generic/hydra_card.html"
    context_object_name = "queryset"
...
class HydraFormView(FormView):
    ...
    template_name = "generic/hydra_form.html"
    ids_key: str = "instance_ids"
...
class HydraNavView(TemplateView):
    ...
    template_name = "generic/hydra_nav.html"
