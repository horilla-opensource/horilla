...
/***/ "./src/js/modules/dashboard/Helpdesk.js":
/*!**********************************************!*\
  !*** ./src/js/modules/dashboard/Helpdesk.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var Helpdesk = /*#__PURE__*/function () {
  function Helpdesk() {
  ...
  _createClass(Helpdesk, [{
    ...
    value: function events() {
      if (this.ticketHeaderEl && this.ticketDetailsEl) {
        this.ticketHeaderEl.addEventListener("click", this.showHideTicketDetails.bind(this));
      }
    }
    /**
    ...
    key: "showHideTicketDetails",
    value: function showHideTicketDetails() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Helpdesk);
...
/* harmony import */ var _modules_dashboard_Helpdesk__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/dashboard/Helpdesk */ "./src/js/modules/dashboard/Helpdesk.js");
/* harmony import */ var _modules_dashboard_OrgChart__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/dashboard/OrgChart */ "./src/js/modules/dashboard/OrgChart.js");
// Imports
...
var helpdesk = new _modules_dashboard_Helpdesk__WEBPACK_IMPORTED_MODULE_17__["default"]();
// const faq = new Faq();
var orgChart = new _modules_dashboard_OrgChart__WEBPACK_IMPORTED_MODULE_18__["default"]();
