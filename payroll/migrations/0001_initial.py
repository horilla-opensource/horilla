    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_type', models.CharField(blank=True, choices=[('cafeteria_benefits', 'Cafeteria Benefits'), ('learning', 'Learning'), ('foreign_language', 'Foreign Language')], max_length=32, null=True, verbose_name='Reimbursement sub type')),
