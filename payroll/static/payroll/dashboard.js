            ...
            options: {
                scales: {
                    x: {
                        ...
                        title: {
                            display: true,
                            text: gettext("Name of Employees"),
                            font: {
                                weight: "bold",
                                size: 16,
                            },
            ...
            success: (response) => {
                ...
                if (isChartEmpty(dataSet)) {
                    $("#employee_canvas_body").html(
                        ...
                        <div style="" class="">
                        <img style="display: block;width: 70px;margin: 10px auto ;" src="${staticUrl + "images/ui/no-money.png"
                        }" class="" alt=""/>
                        <h3 style="font-size:16px" class="oh-404__subtitle">${response.message
                        }</h3>
                        </div>
                    </div>`
                    );
            ...
            success: (response) => {
                ...
                if (department_total.length != 0) {
                    ...
                    $("#department_total_empty").html(
                        ...
                        <div style="" class="">
                        <img style="display: block;width: 70px;margin: 10px auto ;" src="${staticUrl + "images/ui/money.png"
                        }" class="" alt=""/>
                        <h3 style="font-size:16px" class="oh-404__subtitle">${response.message
                        }</h3>
                        </div>
