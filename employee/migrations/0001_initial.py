    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children_info', models.TextField(blank=True, null=True, verbose_name='Children Information')),
                ('np_branch', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nova Poshta Branch')),
                ('np_postomat', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nova Poshta Parcel Locker')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rnokpp', models.CharField(blank=True, max_length=20, null=True, verbose_name='RNOKPP')),
                ('payment_purpose', models.CharField(blank=True, max_length=255, null=True, verbose_name='Payment Purpose')),
                ('fop_maintained', models.BooleanField(default=False, verbose_name='Maintained')),
                ('card_number', models.CharField(blank=True, max_length=32, null=True, verbose_name='Card Number')),
                ('wallet_number', models.CharField(blank=True, max_length=255, null=True, verbose_name='Wallet Number')),
                ('wallet_currency', models.CharField(blank=True, max_length=20, null=True, verbose_name='Wallet Currency')),
                ('additional_info', models.JSONField(blank=True, null=True)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
