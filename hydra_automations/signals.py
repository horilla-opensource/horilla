...
def start_automation():
    ...
    from hydra_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=HydraMailTemplate)
    @receiver(post_save, sender=HydraMailTemplate)
...
def send_automated_mail(
    ...
    from hydra_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from hydra_automations.methods.methods import (
        get_model_class,
