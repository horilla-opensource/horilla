"""
App configuration for the Hydra Automations app.
...
class HydraAutomationConfig(AppConfig):
    """Configuration class for the Hydra Automations Django app."""
    ...
    def ready(self) -> None:
        ...
        try:
            ...
            try:
                from hydra_automations.signals import start_automation
