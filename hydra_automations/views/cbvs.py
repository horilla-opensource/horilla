"""
hydra_automations/views/cbvs.py
"""
...
from hydra_automations.forms import AutomationForm
...
class AutomationSectionView(views.HydraSectionView):
    ...
    template_name = "hydra_automations/section_view.html"
...
class AutomationFormView(views.HydraFormView):
    ...
    template_name = "hydra_automations/automation_form.html"
