...
class AssetCategory(HydraModel):
    """
...
class Asset(HydraModel):
    ...
    objects = HydraCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(HydraModel):
    """
...
class AssetAssignment(HydraModel):
    """
    ...
    objects = HydraCompanyManager("asset_id__asset_lot_number_id__company_id")
