...
class DefaultHydraMailBackend(EmailBackend):
    def __init__(
        self,
        host=None,
        port=None,
...
BACKEND_CLASS: EmailBackend = DefaultHydraMailBackend
default = "base.backends.ConfiguredEmailBackend"

setattr(BACKEND_CLASS, "send_messages", DefaultHydraMailBackend.send_messages)
