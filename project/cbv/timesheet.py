...
class TimeSheetNavView(HydraNavView):
    """
    Nav bar
    """
...
class TimeSheetList(HydraListView):
    """
...
class TimeSheetFormView(HydraFormView):
    """
...
class TimeSheetCardView(HydraCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(HydraDetailedView):
    """
