...
class ProjectStage(HydraModel):
    ...
    objects = HydraCompanyManager("project__company_id")
...
class TimeSheet(HydraModel):
    ...
    objects = HydraCompanyManager("project_id__company_id")
