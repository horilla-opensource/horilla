...
urlpatterns = [
    ...
    path("recruitment/<int:recruitment_id>/candidate/", CandidateGetCreateAPIView.as_view()),
    ...
    path("interview-schedule/<int:pk>/", InterviewScheduleGetUpdateDeleteAPIView.as_view()),
    path("candidate/<int:candidate_id>/interview-schedule/", InterviewScheduleGetCreateAPIView.as_view()),
    ...
    path("skill-zone-candidate/<int:pk>/", SkillZoneCandidateGetUpdateDeleteAPIView.as_view()),
    path("candidate/<int:candidate_id>/skill-zone-candidate/", SkillZoneCandidateGetCreateAPIView.as_view()),
    path("skill-zone/<int:skill_zone_id>/skill-zone-candidate/", SkillZoneCandidateGetCreateAPIView.as_view()),
    ...
    path("candidate/<int:candidate_id>/candidate-rating/", CandidateRatingGetCreateAPIView.as_view()),
    ...
    path("rejected-candidate/<int:pk>/", RejectedCandidateGetUpdateDeleteAPIView.as_view()),
    path("candidate/<int:candidate_id>/rejected-candidate/", RejectedCandidateGetCreateAPIView.as_view()),
    
    # Candidate Document Request URLs
    path("candidate-document-request/", CandidateDocumentRequestGetCreateAPIView.as_view()),
    path("candidate-document-request/<int:pk>/", CandidateDocumentRequestGetUpdateDeleteAPIView.as_view()),
    path("candidate/<int:candidate_id>/candidate-document-request/", CandidateDocumentRequestGetCreateAPIView.as_view()),
    
    # Candidate Document URLs
    path("candidate-document/", CandidateDocumentGetCreateAPIView.as_view()),
    path("candidate-document/<int:pk>/", CandidateDocumentGetUpdateDeleteAPIView.as_view()),
    path("candidate/<int:candidate_id>/candidate-document/", CandidateDocumentGetCreateAPIView.as_view()),
    path("candidate-document-request/<int:document_request_id>/candidate-document/", CandidateDocumentGetCreateAPIView.as_view()),
