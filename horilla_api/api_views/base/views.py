...
from ...api_serializers.base.serializers import (ActiontypeSerializer, CompanySerializer, DepartmentSerializer,
...
class EmployeeTabPermissionCheck(APIView):
    ...
    def get(self,request):
        ...
        if (
            _is_reportingmanger(request, instance)
            or request.user.has_perms(["attendance.view_worktyperequest","perms.attendance.view_shiftrequest"])
