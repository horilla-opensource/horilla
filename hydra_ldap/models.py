...
class LDAPSettings(models.Model):
    ...
    bind_dn = models.CharField(max_length=255, default="cn=admin,dc=hydra,dc=internal")
    bind_password = models.CharField(max_length=255)
    base_dn = models.CharField(max_length=255, default="ou=users,dc=hydra,dc=internal")
